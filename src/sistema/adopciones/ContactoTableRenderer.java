...
public class ContactoTableRenderer implements TableCellRenderer {

    private final TableCellRenderer oldCellRenderer;

    public ContactoTableRenderer(JTable table) {
    ...
    public Component getTableCellRendererComponent(JTable jtable, Object o, boolean bln, boolean bln1, int i, int i1) {
        ...
        TableCellContacto cell = new TableCellContacto((Adopcion) o, com.getFont());
