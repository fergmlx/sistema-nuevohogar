...
public class DetallesTableRenderer implements TableCellRenderer {

    private final TableCellRenderer oldCellRenderer;

    public DetallesTableRenderer(JTable table) {
    ...
    public Component getTableCellRendererComponent(JTable jtable, Object o, boolean bln, boolean bln1, int i, int i1) {
        ...
        TableCellDetalles cell = new TableCellDetalles((Animal) AnimalDAO.obtenerPorId((Integer)jtable.getValueAt(i, 1)), com.getFont());
